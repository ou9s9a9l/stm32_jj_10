...
void RFM96_LoRaEntryRx(void)
{
  ...
  RFM96_LoRaClearIrq();   
   temp1 = SPIRead((u8)(LR_RegPayloadLength>>8));
  //TODO
...
u8 RFM96_LoRaEntryTx(u8 packet_length)
{
		...
		//SPIWrite(LR_RegMaxPayloadLength+packet_length);
