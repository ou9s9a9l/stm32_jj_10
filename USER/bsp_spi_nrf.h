...
#define TX_PLOAD_WIDTH  17   //发射数据通道有效数据宽度0~32Byte 
...
#define R_RX_PLOAD 0x60  // Define RX payload register address
...
#define NRF_Read_IRQ()		  GPIO_ReadInputDataBit ( GPIOB, GPIO_Pin_0)  //中断引脚
#else
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOA, GPIO_Pin_4)
#define NRF_CSN_LOW()       GPIO_ResetBits(GPIOA, GPIO_Pin_4)		        //csn置低
#define NRF_CE_HIGH()	      GPIO_SetBits(GPIOA,GPIO_Pin_1)
